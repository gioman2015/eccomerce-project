                        ...
                        <div class="row">{{-- 4th row --}}
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_size_en" value="Small,Medium,Large" data-role="tagsinput" placeholder="add tags" required=""/>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_size_esp" value="Pequeño,Medio,Grande" data-role="tagsinput" placeholder="add tags" required=""/>
                        ...
                        <div class="row">{{-- 5th row --}}
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_color_en" value="Red,Black" data-role="tagsinput" placeholder="add tags" required=""/>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="product_color_esp" value="Rojo,Negro" data-role="tagsinput" placeholder="add tags" required=""/>
                        ...
                        <div class="row">{{-- 7th row --}}
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="short_descp_en" class="form-control" required placeholder="Textarea text" required=""></textarea>
                                    </div> 
                                </div>
                            </div>{{-- end col-md-6 --}}
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="short_descp_esp" class="form-control" required placeholder="Textarea text" required=""></textarea>
                                    </div>
                                </div>
                            </div>{{-- end col-md-6 --}}
                        </div>{{-- end 7th row --}}
