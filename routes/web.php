...
Route::middleware(['auth:admin'])->group(function(){
    ...
    Route::get('/admin/profile/password', [AdminProfileController::class, 'ChangePassword'])->name('admin.change.password');
    ...
    Route::prefix('brand')->group(function(){
        ...
        Route::get('/edit/{id}', [BrandController::class, 'BrandUpdate'])->name('brand.edit');
        Route::post('/update', [BrandController::class, 'BrandEdit'])->name('brand.update');
